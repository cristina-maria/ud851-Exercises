...
public class NotificationUtils {
    ...
    private static final int PENDING_ID_CODE = 100;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "water-reminder_channel_id";
    ...
    public static Bitmap largeIcon(Context context) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(res, R.drawable.ic_cancel_black_24px);
        return bitmap;
    }
